...
implements IMixinConfigPlugin {
    ...
    public boolean shouldApplyMixin(String targetClassName, String mixinClassName) {
        if (mixinClassName.contains("compat.emi")) {
            return net.fabricmc.loader.api.FabricLoader.getInstance().isModLoaded("emi");
        }
        if (mixinClassName.contains("compat.supermartijn642corelib")) {
            return net.fabricmc.loader.api.FabricLoader.getInstance().isModLoaded("supermartijn642corelib");
        }
        return true;
    }
